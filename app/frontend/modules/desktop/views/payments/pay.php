...
<form lang="en-GB" id="onFormSubmit_paymentForm" method="get" class="payments-form -loading" data-dialog-url="/api/erip-dialog?" data-name="<?= $service->name ?>" data-redirect-url="/payments/history-item?id=">
	...
	<input type="hidden" name="<?= H::F_MODE ?>" value="">
	...
	<h5 class="subscription_rules" data-error="Для проведения платежа необходимо подтвердить согласие на подключение услуги «МТС Деньги»">
		<div class="subscription_rules_text">
			<div class="rules_agree-box_wrap -middle"><?= Html::mtsCheckbox('agree', false, ['class' => 'rules_agree-box']) ?></div>
	...
	<h5 class="rules">
		Нажимая кнопку «Подтвердить&nbsp;платеж», вы подтверждаете, что ознакомлены и согласны с <a href="/help/user-agreement" target="_blank">Правилами&nbsp;системы</a>
	</h5>
	<? endif; ?>
	...
	<? endif; ?>
	<ul class="payments-form-aside">
		<li class="payments-form-aside_item --multiple">...</li>
		<li class="payments-form-aside_item --pay">Оплата</li>
		<li class="payments-form-aside_item --confirm">Подтверждение</li>
	</ul>
</form>
